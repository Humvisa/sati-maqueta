...
function applyGridShift(source, inverse34, point) {
  ...
  outer:
    for (var i = 0; i < source.grids.length; i++) {
      ...
      for (var j = 0, jj = subgrids.length; j < jj; j++) {
        ...
        output = applySubgridShift(input, inverse34, subgrid);
        if (!isNaN(output.x)) {
          break outer;
        }
      }
...
function applySubgridShift(pin, inverse34, ct) {
...
var names36 = ["General Oblique Transformation", "General_Oblique_Transformation", "ob_tran"];
var ob_tran_default = {
  init: init35,
  forward: forward33,
  inverse: inverse33,
